                    ...
                    <div className="element-wrapper">
                      ...
                      <div className="element-box">
                        <h5 className="form-header">
                            About <small className="text-muted text-success">cureCovid19.in</small> 
                    ...
                    <div className="element-wrapper">
                      ...
                      <div className="element-box">
                        ...
                        <div className="form-desc">
                            ...
                            <p className="lead">Q. Are you Official</p>
                            <p>A. No. </p>
                            
                            <p className="lead">Q. Is your Data Reliable</p>
                            ...
                            <p className="lead">Q. What is coronavirus?</p>
                            ...
                            <p className="lead">Q. How does coronavirus spread? </p>
                            ...
                            <p className="lead">Q. Has any vaccine been developed to cure Covid-19?</p>
                            ...
                            <p className="lead">Q. What should I do to stay protected from the virus? </p>
                            ...
                            <p className="lead">Q. Can coronavirus  spread through mosquitoes, cats or dogs? </p>

                            <p>A. Till date, there is no evidence that coronavirus can spread through these animals. </p>

                            <p className="lead">Q. Can coronavirus spread in hot and humid areas?</p> 
