                    ...
                    <div className="element-wrapper">
                      ...
                      <div className="element-box">
                        ...
                        <div>
                            ...
                            <p>A. No. <b style={{fontSize: "15px"}}>This is a Not-for-profit initiative by the alumni of </b> <b style={{backgroundColor: "#F5F5F5", fontSize: "16px", padding: "5px", borderRadius: "8px", "color": "#0074d9", "fontFamily": "courier"}}>BITS Pilani</b>, <b style={{backgroundColor: "#F5F5F5", fontSize: "16px", padding: "5px", borderRadius: "8px", "color": "#0074d9", "fontFamily": "courier"}}>IIIT-Hyderabad</b>, <b style={{backgroundColor: "#F5F5F5", fontSize: "16px", padding: "5px", borderRadius: "8px", "color": "#0074d9", "fontFamily": "courier"}}>University of Washington, Seattle</b> <b> and </b><b style={{backgroundColor: "#F5F5F5", fontSize: "16px", padding: "5px", borderRadius: "8px", "color": "#0074d9", "fontFamily": "courier"}}>University of Oslo, Norway</b>.</p>
