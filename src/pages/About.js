                    ...
                    <div className="element-wrapper">
                      ...
                      <div className="element-box">
                        ...
                        <div>
                            ...
                            <p>A. No. <b style={{fontSize: "15px"}}>This is a Not-for-profit initiative by the alumni of </b> <b style={{backgroundColor: "#F5F5F5", fontSize: "16px", padding: "5px", borderRadius: "8px", "color": "#EC407A", "fontFamily": "courier"}}>BITS Pilani</b> <b>and </b><b style={{backgroundColor: "#F5F5F5", fontSize: "16px", padding: "5px", borderRadius: "8px", "color": "#EC407A", "fontFamily": "courier"}}>IIIT-Hyderabad</b>.</p>
