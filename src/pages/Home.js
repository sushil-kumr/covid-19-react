										...
										<div className="table-responsive text-right">
											<table className="table table-lightborder">
												<thead style={{cursor: "pointer"}}>
													<tr>
													<th className="text-left" id="state" onClick={orderData} style={{fontSize: "10px"}}>
													State <i className={`fa fa-${countryFlag===0?"sort":countryFlag===1?"sort-up":"sort-down"}`} ></i>
													</th>
													<th className="wrap" id="total" onClick={orderData} style={{fontSize: "9px"}}>
													Cnf <i className={`fa fa-${confirmFlag===0?"sort":confirmFlag===1?"sort-up":"sort-down"}`} ></i>
													</th>    
													<th className="wrap" id="active" onClick={orderData} style={{fontSize: "9px"}}>
													Act <i className={`fa fa-${activeFlag===0?"sort":activeFlag===1?"sort-up":"sort-down"}`} ></i>
													</th>
													<th className="wrap" id="recovered" onClick={orderData} style={{fontSize: "9px"}}>
													Rcv <i className={`fa fa-${recoveredFlag===0?"sort":recoveredFlag===1?"sort-up":"sort-down"}`} ></i>
													</th>
													<th className="wrap" id="deaths" onClick={orderData} style={{fontSize: "9px"}}>
													Dcs <i className={`fa fa-${deathFlag===0?"sort":deathFlag===1?"sort-up":"sort-down"}`} ></i>
													</th>
													</tr>
												</thead>
												<tbody>
								...
								<div className="row">
									...
									<div className="col-sm-5">
										<div className="element-wrapper pb-2">
											...
											<div className="element-box pt-0">
												<div className="el-chart-w">
													<Bar data={barChartData} height="200px" options={optionBar} />
										...
										<div className="element-wrapper">
											...
											<div className="element-box pt-0">
												<div className="el-chart-w">
													<Doughnut data={piedata} height="200px"
													options={{ 	maintainAspectRatio: true,
																cutoutPercentage: 60,
																legend: { labels:{fontFamily: ["Inter", "Sans-serif"], boxWidth: 12}} 
															}}
													/>
												</div>
											</div>
									...
									<div className="col-sm-10">
										<div className="element-actions d-sm-block">
											...
											<form className="form-inline justify-content-end">
												...
												<select className="form-control form-control-sm form-control-faded col-4" onChange={handleSubmit}>
													<option value="0">
													All 
													</option>
													<option value="-14">
