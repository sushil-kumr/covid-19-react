...
$(function () {
  ...
  if (typeof Chart !== 'undefined') {
    ...
    } // init lite line chart V1 if element exists
      
    if ($("#liteLineChartV1").length) {
      var liteLineChartV1 = $("#liteLineChartV1");
      var liteLineGradientV1 = liteLineChart[0].getContext('2d').createLinearGradient(0, 0, 0, 200);
      liteLineGradient.addColorStop(0, 'rgba(30,22,170,0.08)');
      liteLineGradient.addColorStop(1, 'rgba(30,22,170,0)');
      var chartData = [13, 28, 19, 24, 43, 49];
      if (liteLineChartV1.data('chart-data')) chartData = liteLineChartV1.data('chart-data').split(','); // line chart data
      ...
      var myLiteLineChartV1 = new Chart(liteLineChartV1, {
        type: 'line',
        data: liteLineDataV1,
        options: {
          legend: {
    ...
    if ($("#lineChart1").length) {
      var lineChart1 = $("#lineChart1"); // line chart data
